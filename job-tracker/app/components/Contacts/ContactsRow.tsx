...
import type { Contact } from "~/utils/typings";

const ContactsRow = (data: Contact) => {
  return (
    ...
    <tr className="border-b" id={data.id}>
      ...
      <td>
        <Form method="post">
          <input name="contact_id" readOnly value={data.id} type="hidden" />
          <button
            type="submit"
            name="_action"
            value="edit"
      ...
      <td>
        <Form method="post">
          ...
          <button
            ...
            name="_action"
            value="delete"
            className="h-5 w-5 pt-1 text-red-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
