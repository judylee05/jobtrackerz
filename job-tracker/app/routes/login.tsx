...
export async function action({ request }: ActionArgs) {
  ...
  // the user object will exist, but the user specific properties shouldn't
  if (!user.id) {
    return json(
    ...
    <div className="flex h-screen flex-col justify-center bg-slate-900">
      <div className="mx-auto w-full max-w-md px-8">
        <h1 className="p-5 text-center text-4xl font-bold text-rose-400 sm:text-5xl md:text-6xl">
          <span className="block xl:inline">Log In</span>
        </h1>
        <Form method="post" className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <label
                htmlFor="remember"
                className="ml-2 block text-sm text-rose-100"
              >
                Remember me
              </label>
            </div>
